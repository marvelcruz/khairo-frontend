      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-zinc-300">
          <section>
            ...
            <p>You may request cancellation by contacting KhairoDietClinic support. Cancellation does not automatically refund payments already processed.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>If you believe there has been a billing error, contact KhairoDietClinic support before initiating a chargeback. We will investigate and respond within a reasonable timeframe.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-white">4. Contact</h2>
            <p>For refund or cancellation requests, contact KhairoDietClinic through the portal support page or WhatsApp.</p>
          </section>
        </div>
      </div>
    </main>
