    ...
    <main className="min-h-screen bg-black px-4 py-12 text-white sm:px-6">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-10 text-sm leading-7 text-zinc-300">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">3. Client Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">4. Payments, Refunds, and Cancellation</h2>
            <p>
              Program fees, renewals, and other charges are processed through secure third-party payment providers. Payment terms, refund eligibility, and cancellation policy are described in our Refund Policy. We may suspend access if payment is overdue.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white">5. Communications</h2>
            <p>
              You may receive service-related communications via email, SMS, WhatsApp, or in-app messages. Marketing communications are sent only where consent has been recorded.
            </p>
          </section>
