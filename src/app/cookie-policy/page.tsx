  ...
  return (
    <main className="min-h-screen bg-black px-4 py-12 text-white sm:px-6">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight">Cookie Policy</h1>
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-zinc-300">
          ...
          <p>
            You can control cookies through your browser settings. Disabling essential cookies may affect your ability to use the portal.
          </p>
        </div>
      </div>
    </main>
